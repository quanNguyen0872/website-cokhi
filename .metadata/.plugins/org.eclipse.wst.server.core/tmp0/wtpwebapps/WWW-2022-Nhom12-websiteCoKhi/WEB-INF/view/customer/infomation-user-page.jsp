								...
								<div class="row">
									<div class="col l-4 ">
										<div class="card-block text-center text-white">
											<div class="m-b-25">
												<img src="${pageContext.request.contextPath }/resources/img/user.png" class="img-radius" alt="User-Profile-Image" />
											</div>
											<h6 class="f-w-600">${customer.lastName } ${customer.firstName }</h6>
											<div class="authentication-form__aside">
												<div class="authentication-form__help">
													<c:url var="updateLink" value="/infomationUserForm">
													</c:url>
													<a href="${updateLink }" class="authentication-form__help-link authentication-form__help-forgot">Chỉnh sửa</a>
													<span class="seperate"></span> 
													<a href="${pageContext.request.contextPath }/showResetPasswordForm" class="authentication-form__help-link">Đổi mật khẩu</a>
												</div>
											</div>
										</div>
									</div>
