							...
							<div class="card user-card-full">
								<div class="row">
									<div class="card-block">
										<div class="row">
											<form:form action="processUpdateUserInfo" method="post" modelAttribute="customer">
												<form:hidden path="id" />
												<div class="col l-12">
													...
													<p class="f-w-600 inputContain">
														<label class="labelInput">Email address: </label>
														<form:input path="email" class="form-control"/>	
													</p>
													<p class="f-w-600 inputContain">
														<label class="labelInput">Address: </label>
														<form:input path="address" class="form-control"/>
													</p>
													<p class="f-w-600 inputContain">
														<label class="labelInput">Phone: </label>
														<form:input path="phoneNumber" class="form-control"/>
													</p>
												</div>
												<a style="margin-left: 250px" href="${pageContext.request.contextPath }/showInfomationUserPage" class="btn">TRỞ LẠI</a>
												<input style="margin-left: 10px" type="submit" class="btn btn--primary" value="Lưu">
											</form:form>
										</div>
									</div>
								</div>
